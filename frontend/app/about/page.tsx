        ...
        <div className="max-w-2xl mx-auto space-y-8">
          ...
          <div className="bg-white rounded-xl shadow-card p-6 border border-primary-100">
            ...
            <p className="text-pine-700 leading-relaxed mb-3">
              Hi, my name is Blanca 👋🏽  I read every day and love to discover new books. </p>

              <p className="text-pine-700 leading-relaxed mb-3">My favorite way of organizing my reading is by making lists. I've often
              wished there was the ability to make some cool lists and share
              them with other readers. </p>

              <p className="text-pine-700 leading-relaxed mb-3">So, I created my very
              own reading tracker. I call it Curio. </p>

              <p className="text-pine-700 leading-relaxed mb-3">Curio allows for book list
              curations. They are shareable and fun! Who wouldn't like to come
              across a list like 'books that would be impossible to make into a
              movie', 'favorite sci-fi's', or 'my
              Stephen King's ranked'. </p>

              <p className="text-pine-700 leading-relaxed mb-3">My app is a work in progress! I'm
              currently working on user profiles, curating my library, and some
              more fun features.
              </p>
          </div>
